...
from cs336_systems.flash_attention.flash_attention_torch import NIUFlashAttention
def get_flashattention_autograd_function_pytorch() -> Type:
    ...
    return NIUFlashAttention



from cs336_systems.flash_attention.flash_attention_triton import NIU_Triton_FlashAttention_Forward
def get_flashattention_autograd_function_triton() -> Type:
    ...
    return NIU_Triton_FlashAttention_Forward
